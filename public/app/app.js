(function () {
	...
	angular.module('app').config(['$routeProvider', '$locationProvider', function ($routeProvider, $locationProvider) {
		...
		$routeProvider
			.when('/', {templateUrl: '/partials/home/index', controller: 'HomeController'})
			.when('/books', {templateUrl: '/partials/books/index', controller: 'BooksController', resolve: {
				books: function ($route, booksService) {
					return booksService.query().$promise;
				}
			}})
			.when('/books/favorites', {templateUrl: '/partials/books/index', controller: 'FavoritesController'})
			.when('/books/top10', {templateUrl: '/partials/books/index', controller: 'Top10Controller'})
			.when('/books/:id', {templateUrl: '/partials/books/book', controller: 'BookController', resolve: {
